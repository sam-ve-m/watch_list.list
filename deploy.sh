fission spec init
fission env create --spec --name wtc-list-list-env --image nexus.sigame.com.br/fission-wacth-list-list:0.2.0-2 --poolsize 0 --version 3 --imagepullsecret "nexus-v3" --spec
